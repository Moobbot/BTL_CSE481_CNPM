<div class="container-fluid custom-background" style="min-height: 85vh; height: auto; max-height: 200vh;">
    <div class="container pb-5">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="chuyenxe">
                        ...
                        <input type="hidden" class="form-control" id="edit_ma_chuyenxe_id" name="ma_chuyenxe">
                            <div class="mb-3">
                                <label for="subjectname" class="form-label">Mã Tuyến Đường</label>
                                <input type="text" class="form-control" id="edit_matd_chuyenxe_id" name="matd_chuyenxe">
                            </div>
                            <div class="mb-3">
                                <label for="subjectname" class="form-label">Giá Tiền Chuyến Xe</label>
                                <input type="text" class="form-control" id="edit_tien_chuyenxe_id" name="tien_chuyenxe">
                            </div>
                            <div class="mb-3">
                                <label for="subjectname" class="form-label">Giờ Đi Chuyến Xe</label>
                                <input type="text" class="form-control" id="edit_gio_chuyenxe_id" name="gio_chuyenxe">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
        ...
        <!-- modal xóa -->
        <div class="modal fade" id="delete_chuyenxe" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form method="POST" action="chuyenxe">
                        <div class="modal-body">
                            <input type="hidden" id="id_chuyenxe_delete" name="deleteChuyenxeID" value="">
                            <p>Bạn có muốn xóa?</p>
                        </div>
                        <div class="modal-footer">
            ...
            <table class="table table-hover table-striped " id="example">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning edit_chuyenxe" data-bs-toggle="modal"
                                data-bs-target="#edit_chuyenxe"
                                name='<?php echo $row['ma_chuyenxe'] . ',' . $row['ma_tuyenduong'] . ',' . $row['giatien_chuyenxe'] . ',' . $row['giodi_chuyenxe'];  ?>'><i><i
                                        class="fas fa-user-edit"></i></a>
                            <a class="btn btn-danger delete_chuyenxe" name='<?php echo $row['ma_chuyenxe'];?>'
                                data-bs-toggle="modal" data-bs-target="#delete_chuyenxe"><i
