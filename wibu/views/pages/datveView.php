        ...
        <form class="mt-5" action="./datve/khachhangdatve" method="POST">
            <fieldset class="border border-dark rounded-3 p-3">
                ...
                <div class="row d-flex justify-content-between">
                    <div class="row mb-5">
                        <div class="ms-5">
                            <label class="ms-2" for="" id="">Số lượng vé: </label> <input type="number">
                    ...
                    <div class="col-5 ms-5">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" id="username" name="username" class="form-control border-dark" placeholder="Enter your name">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-sm-4 ms-2 col-form-label">Số điện thoại:</label>
                            <div class="col-sm-7">
                                <input type="text" id="phone" name="phone" class="form-control border-dark" placeholder="Enter phonenumber">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-sm-4 ms-2 col-form-label">CCCD:</label>
                            <div class="col-sm-7">
                                <input type="text" id="cccd" name="cccd" class="form-control border-dark" placeholder="Enter CMT/CCCD">
                            </div>
                        </div>
                    </div>
                    <div class="col-5">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-7">
                                <input id="address" name="address" type="text" class="form-control border-dark" placeholder="Enter address">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-sm-2 me-4 col-form-label">Email:</label>
                            <div class="col-sm-7">
                                <input type="text" id="email" name="email" class="form-control border-dark ms-3" placeholder="Enter email">
                            </div>
                        </div>
                    </div>
                </div>
