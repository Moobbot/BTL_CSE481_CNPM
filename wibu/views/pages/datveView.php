        ...
        <fieldset class="border border-dark rounded-3 p-3">
              ...
              <div class="row mb-5">
                ...
                <div class="col-5 ms-5">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control border-dark" id = "cccd" name = "cccd">
                        </div>
                    </div>
                </div>
                <div class="col-5">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control border-dark ms-3" id = "email" name = "email">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center pt-5">
                <div class="col-2 text-center">
                    <button type="submit" class="btn btn-danger px-4" name = "btnhuy" >Huỷ</button>
                </div>
                <div class="col-2 text-center">
                    <button type="submit" class="btn btn-primary"  name = "btnthanhtoan">Thanh toán</button>
                </div>
            </div>
