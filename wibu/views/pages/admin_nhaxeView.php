                    ...
                    <form method="POST">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="ten_nhaxe" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="mota_nhaxe" required>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="nhaxe">
                        <div class="modal-body">
                            <input type="hidden" class="form-control" name="id_nhaxe" id="edit_manhaxe_id" required>
                            <div class="mb-3">
                                <label for="subjectname" class="form-label">Tên Nhà Xe</label>
                                <input type="text" class="form-control" name="ten_nhaxe" id="edit_tennhaxe_id" required>
                            </div>
                            <div class="mb-3">
                                <label for="subjectname" class="form-label">Số điện thoại</label>
                                <input type="text" class="form-control" name="sodt_nhaxe" id="edit_sodienthoai_id" required>
                            </div>
                            <div class="mb-3">
                                <label for="subjectname" class="form-label">Địa chỉ</label>
                                <input type="text" class="form-control" name="dc_nhaxe" id="edit_diachi_id" required>
                            </div>
                            <div class="mb-3">
                                <label for="subjectname" class="form-label">Mô tả</label>
                                <input type="text" class="form-control" name="mota_nhaxe" id="edit_mota_id" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning editClass" data-bs-toggle="modal" data-bs-target="#edit_nhaxe" name='<?php echo $row['ma_nhaxe'] . ',' . $row['ten_nhaxe'] . ',' . $row['sdt_nhaxe'] . ',' . $row['diachi_nhaxe'] . ',' . $row['mota_nhaxe'];  ?>'><i class="fas fa-user-edit"></i></a>
                                <a class="btn btn-danger deleteClass" name='<?php echo $row['ma_nhaxe']; ?>' data-bs-toggle="modal" data-bs-target="#delete_nhaxe"><i class="fas fa-user-slash"></i></a>
                            </td>
                        </tr>
                    <?php
                    }
